...
class Ability {
  ...
  Ability(this.name, this.cost, this.charge, this.clipId, this.description);
}
...
final List<Agent> agents = [
  Agent(
      ...
      'Sweden',
      [
        Ability('Aftershock', '100', '2', '2TK7nw3B0kA',
        ...
        Ability('Flashpoint', '200', '2', 'H6EFvy8Ktxs',
        ...
        Ability('Fault Line', 'Free', '1', 'pYqBarWr1ug',
        ...
        Ability('Rolling Thunder', '7 Points', '1', '7sGnlhoDiY4',
  ...
  Agent(
      ...
      'El Salvador',
      [
        Ability('Boom Bot', '100', '1', '9L1zcKM6-Sc',
        ...
        Ability('Paint Shells', '200', '2', '-RUgeNH7Cuw',
        ...
        Ability('Blast Pack', 'Free', '1', 'yz9x4Ypf0SI',
        ...
        Ability('Showstopper', '6 Points', '1', 'rZAun19tD9E',
  ...
  Agent(
      ...
      'Morocco',
      [
        Ability('Trapwire', '200', '2', 'saHuEGcGpYU',
        ...
        Ability('Cyber Cage', '100', '2', 'Jh28VPiVWMI',
        ...
        Ability('Spycam', 'Free', '1', 'QnF9f-sByQE',
        ...
        Ability('Neural Theft', '7 Points', '1', '4Y_mdf38v_A',
  ...
  Agent(
      ...
      'China',
      [
        Ability('Barrier Orb', '300', '1', 'nZRCqqRWzjs',
            "EQUIP a barrier orb. FIRE places a solid wall. ALT FIRE rotates the targeter."),
        Ability('Slow Orb', '100', '2', 'pXIhQpOXd6A',
            "EQUIP a slowing orb. FIRE to throw a slowing orb forward that detonates upon landing, creating a lingering field that slows players caught inside of it."),
        Ability('Healing Orb', 'Free', '1', 'tHQQZ2oWdlk',
        ...
        Ability('Resurrection', '7 Points', '1', 'SvtD0G-u44Y',
  ...
  Agent(
      ...
      'Russia',
      [
        Ability('Owl Drone', '300', '1', '6vX7vhhXrDA',
        ...
        Ability('Shock Bolt', '100', '2', 'GE_AyjdPcNA',
        ...
        Ability('Recon Bolt', 'Free', '1', '4WX_Ad7dQ9A',
        ...
        Ability('Hunters Fury', '7 Points', '1', '-Qjs3b4X5jg',
  ...
  Agent(
      ...
      'USA',
      [
        Ability('Snake Bite', '100', '2', 'ozvJObMxnbY',
        ...
        Ability('Poison Cloud', '200', '1', 'W_7hdkvJ_AE',
        ...
        Ability('Toxic Screen', 'Free', '1', '3xRd7U2azeI',
        ...
        Ability('Vipers Pit', '7 Points', '1', 'nQaMCAtftpQ',
  ...
  Agent(
      ...
      'UK',
      [
        Ability('Blaze', '200', '1', 'EkDGsyCHjmE',
        ...
        Ability('Curveball', '200', '2', 'apxrRIFXO2Y',
            "EQUIP a flare orb that takes a curving path and detonates shortly after throwing. FIRE to curve the flare orb to the left, detonating and blinding any player who sees the orb. ALTERNATE FIRE to curve the flare orb to the right."),
        Ability('Hot Hands', 'Free', '1', 'DB_O4N3Lr40',
        ...
        Ability('Run it Back', '6 Points', '1', 'haZbXfIhOOU',
  ...
  Agent(
      ...
      'S.Korea',
      [
        Ability('Cloudburst', '100', '3', 'SIYFZGswMbc',
  ...
  Agent(
      ...
      'Void',
      [
        Ability('Shrouded Step', '100', '2', 'AA_pcppmevY',
        ...
        Ability('Paranoia', '200', '1', 'ur3eailMCbQ',
        ...
        Ability('Dark Cover', 'Free', '2', 'Y6n8hWH3OYY',
        ...
        Ability('From the Shadows', '7 Points', '1', '_A_7NnTCc_g',
  ...
  Agent(
      ...
      'Mexico',
      [
        Ability('Leer', '200', '2', 'fNKwnXMg5aM',
        ...
        Ability('Devour', '100', '/4', 'ltX5w5lSQic',
  ...
  Agent(
      ...
      'USA',
      [
        Ability('Stim Beacon', '100', '2', 'ORnv5UfDzBM',
        ...
        Ability('Incendiary', '200', '1', '7vjdkOdpEas',
        ...
        Ability('Sky Smoke', 'Free', '3', 'I2__jdzteUY',
        ...
        Ability('Orbital Strike', '6 Points', '1', 'jC_8aGTWW0k',
